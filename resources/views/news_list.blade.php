...
<!--                 <img src="@if (empty($info['attachment'])) /images/newDetail/news02.jpg  @else {{$info['attachment']}} @endif" alt=""> -->
<!--                 <div class="text-box"> -->
<!--                     <h2>{{$info['post_title']}} -->
<!--                     </h2> -->
<!--                     <span> -->
...
<!--                 <ul class="pagination"> -->
<!--                 		<li> -->
<!--                         <a href="/news/list/1" aria-label="Previous"> -->
...
<!--                     </li> -->
<!--                     <li> -->
<!--                         <a href="/news/list/{{ $total_page }}" aria-label="Previous"> -->

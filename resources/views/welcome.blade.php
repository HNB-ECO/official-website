                ...
                <div id="myTabContent" class="tab-content">
                    <div class="tab-pane fade in active" id="tab01">
                        ...
                        <div class="right tab-left-content">
                            ...
                            <h2 class="tab-left-content02">How does HNB push distributed business ecosystem a step further?</h2>
                            <div class="tab-left-content03">
                    ...
                    <div class="tab-pane fade" id="tab02">
                        ...
                        <div class="right tab-left-content">
                            ...
                            <h2 class="tab-left-content02">Why economic model is the engine of disruption economy?</h2>
                            <div class="tab-left-content03">
                    ...
                    <div class="tab-pane fade" id="tab03">
                        ...
                        <div class="right tab-left-content">
                            ...
                            <h2 class="tab-left-content02">What are significant features behind HNB core technology ?</h2>
                            <div class="tab-left-content03">
                    ...
                    <div class="tab-pane fade" id="tab04">
                        ...
                        <div class="right tab-left-content">
                            ...
                            <h2 class="tab-left-content02">How does HNB reshape E-commerce industry ?</h2>
                            <div class="tab-left-content03">
...
<!--                     <li data-target="#myCarousel01" data-slide-to="2"></li> -->
                ...
                <div class="carousel-inner">
                    <div class="item active">
                        <img src="/images/index/index02.jpg" alt="First slide">
                    </div>
<!--                     <div class="item"> -->
<!--                         <img src="/images/index/index02.jpg" alt="Second slide"> -->
<!--                     </div> -->
<!--                     <div class="item"> -->
